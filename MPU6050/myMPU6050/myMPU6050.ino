// 本代码在Devymex工作的基础上修改而成，遵循GNU GENERAL PUBLIC LICENSE V3.0
// http://www.gnu.org/licenses/gpl-3.0.en.html
// 相关文档参见原作者于知乎专栏发表的原创文章：
...
void setup() {
  ...
  Wire.begin(); //初始化Wire库
  while(1){
    int flag = Serial.read(); //等待上位机的启动命令
    if(flag == 'y') break;
  }
...
void loop() {
 ...
 //更新Roll角和Pitch角
  ...
  //向串口打印输出Pitch角的角度、角速度和角加速度
  Serial.print(fNewPitch); Serial.print(':');Serial.print(fPitchRate);
  Serial.print(':'); Serial.print(realVals[5]);Serial.println('*'); 
  delay(10);
}
